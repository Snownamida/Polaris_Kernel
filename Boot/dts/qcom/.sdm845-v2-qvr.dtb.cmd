cmd_arch/arm64/boot/dts/qcom/sdm845-v2-qvr.dtb := mkdir -p arch/arm64/boot/dts/qcom/ ; ../scripts/gcc-wrapper.py /home/snowtear/kernel/toolchain/bin/aarch64-linux-android-gcc -E -Wp,-MD,arch/arm64/boot/dts/qcom/.sdm845-v2-qvr.dtb.d.pre.tmp -nostdinc -I../arch/arm64/boot/dts -I../arch/arm64/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.sdm845-v2-qvr.dtb.dts.tmp ../arch/arm64/boot/dts/qcom/sdm845-v2-qvr.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/sdm845-v2-qvr.dtb -b 0 -i ../arch/arm64/boot/dts/qcom/ -Wno-unit_address_vs_reg -d arch/arm64/boot/dts/qcom/.sdm845-v2-qvr.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.sdm845-v2-qvr.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.sdm845-v2-qvr.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.sdm845-v2-qvr.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.sdm845-v2-qvr.dtb.d

source_arch/arm64/boot/dts/qcom/sdm845-v2-qvr.dtb := ../arch/arm64/boot/dts/qcom/sdm845-v2-qvr.dts

deps_arch/arm64/boot/dts/qcom/sdm845-v2-qvr.dtb := \
  ...
  ../arch/arm64/boot/dts/qcom/sdm845-qvr.dtsi \
  ...
  ../arch/arm64/boot/dts/qcom/fg-gen3-batterydata-mlp446579-3800mah.dtsi \
  ../arch/arm64/boot/dts/qcom/sdm845-camera-sensor-qvr.dtsi \

arch/arm64/boot/dts/qcom/sdm845-v2-qvr.dtb: $(deps_arch/arm64/boot/dts/qcom/sdm845-v2-qvr.dtb)
